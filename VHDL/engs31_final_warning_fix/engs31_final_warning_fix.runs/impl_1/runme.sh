...
HD_PWD='O:/ES31_S26/Final_Project/fixing_warnings/ENGS31FINAL-main/VHDL/engs31_final_warning_fix/engs31_final_warning_fix.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log final_top_shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source final_top_shell.tcl -notrace
