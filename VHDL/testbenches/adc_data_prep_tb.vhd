...
entity adc_data_prep_tb is
end adc_data_prep_tb;

architecture testbench of adc_data_prep_tb is

    signal clk            : std_logic := '0';
    signal adc_data       : std_logic_vector(DATA_WIDTH_C - 1 downto 0) := (others => '0');
    signal shift_en       : std_logic := '0';
    signal processed_data : processed_reg_type;
